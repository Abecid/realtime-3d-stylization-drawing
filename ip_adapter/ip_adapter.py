        ...
        **kwargs,
        ...
        with torch.inference_mode():
            ...
            if prompt_embeds.shape[0] == 1:
                ...
                prompt_embeds = torch.cat([prompt_embeds, image_prompt_embeds.repeat(prompt_embeds.shape[0], 1, 1)], dim=1)
                negative_prompt_embeds = torch.cat([negative_prompt_embeds, uncond_image_prompt_embeds.repeat(prompt_embeds.shape[0], 1, 1)], dim=1)
